 ...
 *
 * Rendered inside the board column (ActiveGamePanel) so it covers
 * exactly the chess board — not the entire screen.
 *
...
export function VersusScreen({
  ...
  return (
    ...
    <div
      className={cn(
        'absolute inset-0 z-50 overflow-hidden flex flex-col items-center justify-center',
    ...
    >
      ...
      <div
        className={cn(
          'relative z-20 flex flex-col items-center gap-2 transition-all duration-500',
